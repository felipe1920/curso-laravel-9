"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_rollup_dist_es_shared_watch_js"],{
...
/* harmony import */ var _rollup_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rollup.js */ "./node_modules/rollup/dist/es/shared/rollup.js");
...
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! node:perf_hooks */ "node:perf_hooks");
/* harmony import */ var node_crypto__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! node:crypto */ "node:crypto");
...
const fs$3 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const { Readable } = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'stream'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const sysPath$3 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const { promisify: promisify$3 } = util__WEBPACK_IMPORTED_MODULE_5__;
const picomatch$1 = _rollup_js__WEBPACK_IMPORTED_MODULE_2__.picomatch.exports;
...
const picomatch = _rollup_js__WEBPACK_IMPORTED_MODULE_2__.picomatch.exports;
...
(function (exports) {
	...
	const {sep} = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
	const {platform} = process;
	const os = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'os'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const fs$2 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const sysPath$2 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const require$$3 = /*@__PURE__*/(0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__.getAugmentedNamespace)(_rollup_js__WEBPACK_IMPORTED_MODULE_2__.fseventsImporter);

const fs$1 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const sysPath$1 = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const { EventEmitter } = events__WEBPACK_IMPORTED_MODULE_6__;
const fs = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'fs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
const sysPath = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'path'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class FileWatcher {
    ...
    createWatcher(transformWatcherId) {
        ...
        const isLinux = (0,node_os__WEBPACK_IMPORTED_MODULE_3__.platform)() === 'linux';
...
class Watcher {
    constructor(optionsList, emitter) {
        ...
        node_process__WEBPACK_IMPORTED_MODULE_1__.nextTick(() => this.run());
    }
    async close() {
        if (this.closed)
            return;
...
class Task {
    constructor(watcher, options) {
        ...
        this.outputFiles = this.outputs.map(output => {
            if (output.file || output.dir)
                return (0,node_path__WEBPACK_IMPORTED_MODULE_0__.resolve)(output.file || output.dir);
            return undefined;
        });
        const watchOptions = this.options.watch || {};
        this.filter = (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__.createFilter)(watchOptions.include, watchOptions.exclude);
    ...
    async run() {
        ...
        let result = null;
        try {
            result = await (0,_rollup_js__WEBPACK_IMPORTED_MODULE_2__.rollupInternal)(options, this.watcher.emitter);
            if (this.closed) {
                return;
            }
